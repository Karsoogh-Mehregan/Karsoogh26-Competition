...
@extend_schema(
    ...
    description=(
        ...
        "less than was granted. Resumes a paused game in the same call — a game stopped "
        "at the buzzer plays on — while leaving `not_started` and `finished` alone. "
        "Publishes a `game.state` event."
    ),
